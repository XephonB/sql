...
SET @FechaI='2017-09-15'
SET @FechaF='2017-10-15'
...
'Cantid'=CASE WHEN Venta.Mov in ('Cancelacion Factura','Devolucion Venta','Devolucion Global') THEN -1*VentaD.Cantidad ELSE VentaD.Cantidad END,VentaD.Unidad,Venta.Id
,VentaCobro.FormaCobro1, VentaCobro.FormaCobro2,VentaCobro.FormaCobro3, VentaCobro.FormaCobro4, VentaCobro.FormaCobro5--,VentaCobro.ID,Venta.Mov
FROM Venta 
...
Venta.Mov in ('Nota','Factura POS') 
AND (VentaCobro.FormaCobro1 not in ('TC Pagos Fijos Assis') OR VentaCobro.FormaCobro2 not in ('TC Pagos Fijos Assis') OR 
VentaCobro.FormaCobro3 not in ('TC Pagos Fijos Assis') OR VentaCobro.FormaCobro4 not in ('TC Pagos Fijos Assis') OR VentaCobro.FormaCobro5 not in ('TC Pagos Fijos Assis'))
